...
```{r}
boxplot(as.numeric(edate - sdate))
...
The variables were given different names because they pertain to seperate entitites, meaning that they are different variables that are present in seperate tables, which is why they have different names
